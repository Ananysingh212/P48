...
function preload(){
  bgImg = loadImage("assets/bgD.jpg")
  bgImg2 = loadImage("assets/bgN.jpg")
...
//background image
bg = createSprite(displayWidth/2,displayHeight/2-50,displayWidth,displayHeight-200);
getBackgroundImg();


//creating top and bottom grounds
bottomGround = createSprite(200,displayHeight-200,800,20);
...
gameOver = createSprite(displayWidth/2-50,displayHeight/2-160);
restart = createSprite(displayWidth/2-50,displayHeight/2-120);
...
function spawnObstaclesTop() 
{
  if(World.frameCount % 60 === 0) {
    obstacleTop = createSprite(400,300,40,50);
...
{
  if(World.frameCount % 60 === 0) {
    obstacleBottom = createSprite(400,490,40,50);
